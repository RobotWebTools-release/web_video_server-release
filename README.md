## web_video_server (kinetic) - 0.2.1-1

The packages in the `web_video_server` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release web_video_server --ros-distro kinetic --track kinetic` on `Wed, 05 Jun 2019 07:43:26 -0000`
...
## web_video_server (kinetic) - 0.1.0-0

The packages in the `web_video_server` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release web_video_server --track kinetic -r kinetic` on `Sun, 01 Jul 2018 03:08:38 -0000`
...
## web_video_server (jade) - 0.0.4-0

The packages in the `web_video_server` repository were released into the `jade` distro by running `/usr/bin/bloom-release --rosdistro jade --track jade web_video_server` on `Tue, 18 Aug 2015 14:21:46 -0000`
...
## web_video_server (indigo) - 0.0.4-0

The packages in the `web_video_server` repository were released into the `indigo` distro by running `/usr/bin/bloom-release --rosdistro indigo --track indigo web_video_server` on `Tue, 18 Aug 2015 14:20:45 -0000`
